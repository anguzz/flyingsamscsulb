...
>
    ...
    >
        ...
        <div>
            Non-profit organization dedicated to providing free quality healthcare
        </div>
    ...
    <div class="w-[95%] p-1 md:w-5/12">
        ...
        >
            <div
                class="absolute inset-0 z-[8] h-full w-full overflow-hidden bg-blue-700 bg-fixed opacity-0 transition duration-300 ease-in-out group-hover:opacity-15"
            />

            <div class="transition-all duration-500 group-hover:scale-105" title="">
                <img src="{members}" />
            </div>
            <div
